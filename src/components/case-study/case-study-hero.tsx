      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-10 max-w-5xl">
          ...
          <h1
            ...
            className="mt-6 max-w-5xl text-5xl leading-[1.02] font-medium text-balance max-[379px]:text-[2.6rem] max-[379px]:leading-[1.04] sm:text-6xl lg:text-7xl xl:text-[5.1rem]"
          >
            {metadata.hero.title}
          </h1>
